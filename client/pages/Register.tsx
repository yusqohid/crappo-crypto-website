    ...
    <div className="min-h-screen bg-crypto-dark text-white">
      ...
      <div className="max-w-[1440px] mx-auto px-6 lg:px-[120px] py-16">
        <div className="text-center">
          <h1 className="font-rubik font-bold text-4xl lg:text-6xl text-white mb-8">Register</h1>
          <p className="font-rubik text-lg text-crypto-grey mb-8 max-w-2xl mx-auto">
            This page is a placeholder. Continue prompting to add content for the Register page.
          </p>
          <Link 
            to="/" 
