  ...
  return (
    <div className="min-h-screen bg-crypto-dark text-white relative overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden">
        <div className="absolute top-20 right-10 w-32 h-32 bg-purple-500/10 rounded-full blur-xl"></div>
        <div className="absolute bottom-20 left-10 w-40 h-40 bg-crypto-blue/10 rounded-full blur-xl"></div>
        <div className="absolute top-1/3 left-1/3 transform -translate-x-1/2 -translate-y-1/2 w-96 h-96 bg-purple-500/5 rounded-full blur-3xl"></div>
      </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="space-y-2">
                  ...
                  <div className="relative">
                    <User className="absolute left-3 top-1/2 transform -translate-y-1/2 w-5 h-5 text-crypto-grey" />
                    <Input
                      id="firstName"
                      name="firstName"
                      type="text"
              ...
              <div className="flex items-start space-x-3">
                <input
                  ...
                  onChange={handleInputChange}
                  className="mt-1 w-4 h-4 bg-white/5 border border-white/20 rounded focus:ring-crypto-blue focus:ring-2 text-crypto-blue"
                />
                <label
                  htmlFor="agreeToTerms"
                  className="font-rubik text-sm text-crypto-grey"
                >
                  I agree to the{" "}
                  <Link
                    to="#"
